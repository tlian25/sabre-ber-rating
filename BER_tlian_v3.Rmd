...
for (y in years) {
  ...
  BER_shrink_dt = calculate_BER_value_function_league_pf_fip(current_year_dt, 
                                                             shrk$vl.shrink)
...
# Export shrinkage value functions across all seasons
vl.shrink.all = do.call(rbind, shrink_list)
